...
import 'package:school_management_system_01/dashBoardStudent/grids%20destination/StudentCalender.dart';
import 'package:school_management_system_01/dashBoardStudent/grids%20destination/studentCources.dart';
import 'package:school_management_system_01/dashBoardStudent/grids%20destination/studentHomeWorks.dart';
...
class StudentGridDashBoard extends StatelessWidget {
  ...
  Items item2 = new Items(
    ...
    page: StudentHomeWorks(),
    img: "assets/images/004-assignment.png",
  );
  Items item3 = new Items(
    title: "Axams Notes",
    subtitle: "Lucy Mao going to Office",
    page: StudentNotesPage(),
    img: "assets/images/010-A+.png",
  );
  Items item4 = new Items(
    title: "Calender",
    subtitle: "Rose favirited your Post",
    page: StudentCalender(),
    img: "assets/images/019-timetable.png",
  );
